...
here::here()
#load data
FT.sums <- read.csv("04_ANCOVA_SIMPER_BIPOLT Analyses/Data/Functional_trait_comm_dat.csv")
sums <- read.csv("04_ANCOVA_SIMPER_BIPOLT Analyses/Data/Species_comm_dat.csv")
TL <- read.csv("04_ANCOVA_SIMPER_BIPOLT Analyses/Data/fish_diets.csv")
com.dat.fish <- read.csv("02_Ordination Analysis/Data/com.dat.fish.csv")
#set color pal
wes_palettes <- list(
...
#jpeg("04_ANCOVA_SIMPER_BIPOLT Analyses/Plots/biplot_species.jpeg", 
 #    width = 8.5, height = 8.5, units = "cm", res = 600, pointsize = 8)
plot(coords$MDS1, coords$MDS2,  type = "n", xlab = "nMDS1", xlim = c(-0.4,0.4), ylim = c(-0.3,0.3), ylab = "nMDS2", main = "")
abline(h = 0, lty = 2)
abline(v = 0, lty = 2)
text(col.FT$MDS1, col.FT$MDS2, labels = col.FT$FT,col = col.FT$col, cex = 1)
...
plot(com.fit, col= c(t_col(com.fit.df$col[1], com.fit.df$t_col[1]),
                     ...
                     t_col(com.fit.df$col[26], com.fit.df$t_col[26]),
                     t_col(com.fit.df$col[27], com.fit.df$t_col[27])), 
                     cex = 0.9, lwd = 6)
text(-0.155, -0.23, labels = "Striped Killifish", col = com.fit.df$col[22], cex = 0.9)
...
#jpeg("04_ANCOVA_SIMPER_BIPOLT Analyses/Plots/biplot_feeding_habit.jpeg", width = 8.5, height = 8.5, units = "cm", res = 400)
plot(coords$MDS1, coords$MDS2,  type = "n", xlab = "nMDS1", xlim = c(-0.4,0.4), ylim = c(-0.3,0.3), ylab = "nMDS2", main = "")
abline(h = 0, lty = 2)
abline(v = 0, lty = 2)
text(col.FT$MDS1, col.FT$MDS2, labels = col.FT$FT,col = col.FT$col)
plot(feed.fit, col= c(t_col(feed.fit.df$col[1], feed.fit.df$t_col[1]),
                     ...
                     t_col(feed.fit.df$col[4], feed.fit.df$t_col[4])), lwd = 6)
