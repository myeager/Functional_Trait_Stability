...
morph_FTs <- read.csv("01_Modeling FTs/Data/All_FD_Data.csv")
Nutri_FTs <- read.csv("01_Modeling FTs/Data/FT_Nutrients_data.csv")
com.dat <- read.csv("01_Modeling FTs/Data/community_data_FT.csv")
```
Clean Dfs
```{r}
...
#Biomass GAM fit
png("/Users/mallarie.yeager/Documents/R_projects/FT Stability/Modeling FTs/Plots/gam_fit_plot.png",
    width = 800, height = 600, units = "px", bg = "white")
par(mfrow= c(3,4))
#plot(morph_FTs$FL, morph_FTs$Biomass, col = as.character(morph_FTs$col), pch = 16,
 #    xlab = "Fork Length (mm)", ylab = "Biomass (log10(g))")
#for(i in 1:nrow(uni.spc)){
...
##N_P gam
plot(pred.com.FT$N_P_gam, pred.com.FT$NH4)
plot(pred.com.FT$N_P_gam, pred.com.FT$PO4)



##N_P post gam
plot(pred.com.FT$N_P, pred.com.FT$NH4)
plot(pred.com.FT$N_P, pred.com.FT$PO4)
plot(pred.com.FT$NH4, pred.com.FT$PO4)

ggplot(pred.com.FT, aes(x = PO4, y = NH4, color = log10(N_P))) +
  geom_point(size = 2)+
  theme_bw()
