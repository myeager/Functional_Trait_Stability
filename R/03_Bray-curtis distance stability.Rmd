...
FT.sums <- read.csv("03_Bray Curtis dinstances_Stability/Data/Functional_trait_comm_dat.csv")
sums <- read.csv("03_Bray Curtis dinstances_Stability/Data/Species_comm_dat.csv")
...
beta.yr_yr_mean_pond_type <- aggregate(rel_distance ~ Pond + Type, beta.yr_to_yr_dist, mean)
beta.yr_yr_mean_pond_type <- beta.yr_yr_mean_pond_type[order(beta.yr_yr_mean_pond_type$Pond),]

boxplot(beta.yr_to_yr_dist$rel_distance ~ Type + Pond, beta.yr_to_yr_dist, las  =2)


, ylab = "Relative year to year distance",
        names = c("Species", "Functional Traits"), xlab = "Composition Type")
points(beta.yr_yr_mean_pond_type$rel_distance, pch = 16)
```
