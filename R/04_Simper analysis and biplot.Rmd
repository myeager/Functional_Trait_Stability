...
here::here()
#load data
FT.sums <- read.csv("04_ANCOVA_SIMPER_BIPLOT Analyes/Data/Functional_trait_comm_dat.csv")
sums <- read.csv("04_ANCOVA_SIMPER_BIPLOT Analyes/Data/Species_comm_dat.csv")
TL <- read.csv("04_ANCOVA_SIMPER_BIPLOT Analyes/Data/fish_diets.csv")
#set color pal
wes_palettes <- list(
